...
@section('content')
    ...
    <section class="services-section-three">
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-4 service-block-three">
                    <div class="inner-box">
                        <div class="image"><img src="{{ asset('assets/images/resource/image-32.jpg') }}" alt=""></div>
                        <div class="lower-content">
                            <div class="icon"><i class="flaticon-blueprint-4"></i></div>
                            <h4><a href="{{ route('serviceDetails') }}">Architecture Design</a></h4>
                            <div class="text">The basic philosophy of our studio is to create <br> individual, aesthetically stunning</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 service-block-three">
                    <div class="inner-box">
                        <div class="image"><img src="{{ asset('assets/images/resource/image-33.jpg') }}" alt=""></div>
                        <div class="lower-content">
                            <div class="icon"><i class="flaticon-ruler"></i></div>
                ...
                <div class="col-lg-4 service-block-three">
                    <div class="inner-box">
                        <div class="image"><img src="{{ asset('assets/images/resource/image-34.jpg') }}" alt=""></div>
                        <div class="lower-content">
                            <div class="icon"><i class="flaticon-scale"></i></div>
                            <h4><a href="{{ route('serviceDetails') }}">Exterior Design</a></h4>
                            <div class="text">The basic philosophy of our studio is to create <br> individual, aesthetically stunning</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 service-block-three">
                    <div class="inner-box">
                        <div class="image"><img src="{{ asset('assets/images/resource/image-35.jpg') }}" alt=""></div>
                        <div class="lower-content">
                            <div class="icon"><i class="flaticon-tools"></i></div>
                            <h4><a href="{{ route('serviceDetails') }}">Renovation</a></h4>
                            <div class="text">The basic philosophy of our studio is to create <br> individual, aesthetically stunning</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 service-block-three">
                    <div class="inner-box">
                        <div class="image"><img src="{{ asset('assets/images/resource/image-36.jpg') }}" alt=""></div>
                        <div class="lower-content">
                            <div class="icon"><i class="flaticon-blueprint-2"></i></div>
                            <h4><a href="{{ route('serviceDetails') }}">Landscape Design</a></h4>
                            <div class="text">The basic philosophy of our studio is to create <br> individual, aesthetically stunning</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 service-block-three">
                    <div class="inner-box">
                        <div class="image"><img src="{{ asset('assets/images/resource/image-37.jpg') }}" alt=""></div>
                        <div class="lower-content">
                            <div class="icon"><i class="flaticon-drill-1"></i></div>
                            <h4><a href="{{ route('serviceDetails') }}">Crafted Design</a></h4>
                            <div class="text">The basic philosophy of our studio is to create <br> individual, aesthetically stunning </div>
                        </div>
                    </div>
                </div>
